  ...
  return (
    <div className="border border-border rounded-lg overflow-hidden bg-white dark:bg-slate-950">
      <div className="bg-muted p-2 border-b border-border flex flex-wrap gap-1">
        ...
        <Button size="sm" variant="outline" onClick={() => imageInputRef.current?.click()} title="Insert Image" className="h-8 px-2">
      ...
      <div
        ...
        className="min-h-[400px] p-4 focus:outline-none text-base leading-relaxed prose-sm max-w-none"
        style={{
