        ...
        <div className="flex gap-2 flex-col sm:flex-row w-full sm:w-auto">
          <div className="flex-1 sm:flex-auto">
            <Button 
              ...
              className="w-full sm:w-auto hover:bg-blue-50 hover:border-blue-600 hover:text-blue-600 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
